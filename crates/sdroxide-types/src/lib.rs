...
pub use radio::{
    ...
    SoundFormat, SpyServerConfig, SpyServerFormat, StopBits, TRUSDX_NG_RX_RATE_CW_HZ,
    TRUSDX_NG_TX_RATE_HZ, TRUSDX_NG_TX_START_BYTE, TRUSDX_RX_RATE_HZ, TRUSDX_TX_ESCAPE_TO,
    TRUSDX_TX_RATE_HZ, TciConfig,
