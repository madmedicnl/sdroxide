...
6. **Listening (SWL).** Turn on **SWL mode** for that radio (Settings → Radio →
 ...
 7. **Everything else** — FT8/FT4/FT2, JT65/JT9, FST4, MSK144, WSPR, PSK/RTTY, Olivia, SSTV, RIFP,
...
- **Digital modes** — **FT8/FT4/FT2**, **JT65/JT9**, **FST4**, **MSK144**, **JS8**, **WSPR**, **PSK31/RTTY**,
